...
#include <stdio.h>
#include <windows.h>
#include <gl\glut.h>           //OpenGL을 사용하기 위해서 헤더파일  
#include <gl\gl.h>             //OpenGL을 사용하기 위해서 헤더파일 
#include <gl\glu.h>            //OpenGL을 사용하기 위해서 헤더파일 
#include <gl\glaux.h>          //OpenGL을 사용하기 위해서 헤더파일 
 
#include <stdlib.h>         //exit() 함수를 이용하기위해 불러오는 헤더파일  
